...
- **[Dependency Freshness Checker](https://github.com/Armigerous/dependency-freshness-mcp)** - npm & PyPI outdated package checker for AI coding agents. Returns latest version, deprecation status, versions-behind count, and a dated, cited breaking-change changelog diff. One tool: `check_dependency_freshness`. Remote Apify-hosted endpoint or `npx -y dependency-freshness-mcp`.
